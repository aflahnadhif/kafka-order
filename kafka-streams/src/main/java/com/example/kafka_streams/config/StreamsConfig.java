...
public class StreamsConfig {
    ...
    /*
     * NOTE: Bean name is customized as there already bean with the same name
     */
    ...
    public KafkaStreamsConfiguration kafkaStreamsConfig() {
        ...
        props.put(org.apache.kafka.streams.StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG, Serdes.DoubleSerde.class.getName());
